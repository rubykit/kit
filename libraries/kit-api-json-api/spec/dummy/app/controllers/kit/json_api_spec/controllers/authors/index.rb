module Kit::JsonApiSpec::Controllers::Authors::Index
  ...
  ROUTE_UID = "kit_api_json_api|specs|#{ ROUTE_ID }"
  ...
  def self.endpoint(request:)
    Kit::Organizer.call({
      list: [
        ...
        #Kit::Api::JsonApi::Controllers::JsonApi.method(:validate_query),
        Kit::Api::JsonApi::Services::QueryResolver.method(:resolve),
        Kit::Api::JsonApi::Services::QuerySerializer.method(:serialize),
