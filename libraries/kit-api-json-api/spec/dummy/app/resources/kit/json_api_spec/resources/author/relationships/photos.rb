module Kit::JsonApiSpec::Resources::Author::Relationships::Photos
  ...
  def self.relationship
    {
      ...
      inherited_filter:           ->(query_node:) do
        ...
        if values.size > 0
          Kit::Api::JsonApi::Types::Condition[op: :and, values: [
            ...
            Kit::Api::JsonApi::Types::Condition[op: :eq, column: :imageable_type, values: ['Kit::JsonApiSpec::Models::Write::Author']],
          ],]
        else
          nil
        end
      ...
      select_relationship_record: ->(parent_record:) do
        ->(child_record) { parent_record[:raw_data].id == child_record[:raw_data].imageable_id && child_record[:raw_data].imageable_type == 'Kit::JsonApiSpec::Models::Write::Author' }
      end,
    }
  end
