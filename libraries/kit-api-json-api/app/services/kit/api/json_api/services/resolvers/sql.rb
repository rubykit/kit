...
module Kit::Api::JsonApi::Services::Resolvers::Sql
  ...
  def self.sql_query(ar_model:, filtering: nil, sorting: [], limit: nil, assemble_sql_query: nil)
    ...
    status, ctx = Kit::Organizer.call({
      list: [
        Kit::Api::JsonApi::Services::Resolvers::Sql::Filtering.method(:filtering_to_sql_str),
        Kit::Api::JsonApi::Services::Resolvers::Sql::Sorting.method(:sorting_to_sql_str),
