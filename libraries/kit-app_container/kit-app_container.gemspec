...
Gem::Specification.new do |s|
  ...
  s.homepage    = 'https://github.com/rubykit/kit/tree/master/libraries/kit-app_container'

  s.metadata = {
    'source_code_base_uri' => 'https://github.com/rubykit/kit',
    'source_code_uri'      => "https://github.com/rubykit/kit/tree/v#{ version }/libraries/kit-app_container",
