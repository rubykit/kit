...
DOC_CONFIG = Kit::Doc::Services::Config.get_default_config(
  ...
  output_dir_base:    ENV['KIT_DOC_OUTPUT_DIR_BASE'].presence || 'docs/dist/kit-contract',
    ...
    'Services'           => [
      {
        ...
        css_classes:   Kit::Doc::Services::Tasks.display_helper_css_padding(hide: 'Kit::Contract::Services::'),
      },
    ],
    'Built-in Contracts' => [
      {
        ...
        display_title: Kit::Doc::Services::Tasks.display_helper_last_name,
        css_classes:   Kit::Doc::Services::Tasks.display_helper_css_padding(hide: 'Kit::Contract::BuiltInContracts::'),
      },
    ],
    'Various'            => [
      {
