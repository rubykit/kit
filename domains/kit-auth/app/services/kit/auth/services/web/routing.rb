module Kit::Auth::Services::Web::Routing
  ...
  def self.mount_routes_http_web(context:, rails_endpoint_wrapper:)
    list = [
      { route_id: 'web|users|sign_in|with_password|new',              path: '/web/sign-in',                           verb: :get,    namespace: [:authorization] },
      { route_id: 'web|users|sign_in|with_password|create',           path: '/web/sign-in',                           verb: :post,   namespace: [:authorization] },

      { route_id: 'web|users|sign_in|with_magic_link|request|new',    path: '/web/sign-in/magic-link',                verb: :get,    namespace: [:authorization] },
      { route_id: 'web|users|sign_in|with_magic_link|request|create', path: '/web/sign-in/magic-link',                verb: :post,   namespace: [:authorization] },
      { route_id: 'web|users|sign_in|with_magic_link|create',         path: '/web/sign-in/use-magic-link',            verb: :get,    namespace: [:authorization] },

      { route_id: 'web|users|sign_up|with_password|new',              path: '/web/sign-up',                           verb: :get,    namespace: [:users] },
      { route_id: 'web|users|sign_up|with_password|create',           path: '/web/sign-up',                           verb: :post,   namespace: [:users] },

      { route_id: 'web|users|sign_out|destroy',                       path: '/web/sign-out',                          verb: :delete, namespace: [:authorization] },
      ...
      { route_id: 'web|users|password_reset|request|new',             path: '/web/reset-password',                    verb: :get,    namespace: [:password] },
      { route_id: 'web|users|password_reset|request|create',          path: '/web/reset-password',                    verb: :post,   namespace: [:password] },
  ...
  def self.mount_routes_http_web_oauth(context:, rails_endpoint_wrapper:)
    list = [
      ...
      { route_id: 'web|users|oauth|sign_up',    path: '/web/oauth/sign-up/:provider',                verb: :get,    namespace: [:oauth], request_config: { intent_type: :user_auth } },
      { route_id: 'web|users|oauth|sign_in',    path: '/web/oauth/sign-in/:provider',                verb: :get,    namespace: [:oauth], request_config: { intent_type: :user_auth } },
