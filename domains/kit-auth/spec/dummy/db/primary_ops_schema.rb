...
ActiveRecord::Schema.define(version: 2019_08_03_140621) do
  ...
  create_table "event_store_events", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["data"], name: "index_event_store_events_on_data", using: :gin
    t.index ["event_type"], name: "index_event_store_events_on_event_type"
    t.index ["metadata"], name: "index_event_store_events_on_metadata", using: :gin
  end
  ...
  create_table "oauth_access_tokens", force: :cascade do |t|
    ...
    t.bigint "last_request_metadata_id"
    t.index ["application_id"], name: "index_oauth_access_tokens_on_application_id"
    t.index ["deleted_at"], name: "index_oauth_access_tokens_on_deleted_at"
    t.index ["last_request_metadata_id"], name: "index_oauth_access_tokens_on_last_request_metadata_id"
  ...
  add_foreign_key "oauth_access_tokens", "request_metadata", column: "last_request_metadata_id"
