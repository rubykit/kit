...
module Yard::Kit::Services::Search
  ...
  def self.handle_extras(options:, url_generator:, **)
    list = Yard::Kit::Services::Extras.get_extras_list(options: options)
  ...
  def self.handle_methods(options:, url_generator:, anchor_generator:, verifier_runner:)
    list = Yard::Kit::Services::Modules.get_all_methods_as_list({
      options:         options,
      verifier_runner: verifier_runner,
    })
  ...
  def self.handle_constants(options:, url_generator:, anchor_generator:, verifier_runner:)
    list = Yard::Kit::Services::Modules.get_all_constants_as_list({
      options:         options,
      verifier_runner: verifier_runner,
    })
  ...
  def self.clean_content(content:)
    content = Yard::Kit::Services::Utils.remove_html_tags(content)
      .gsub("\n", ' ')
      .gsub(/\s+/, ' ')
